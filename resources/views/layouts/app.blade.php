...
<head>
    ...
    <link href="{{asset('\open-iconic-master\font\css\open-iconic-foundation.css')}}" rel="stylesheet">
    <!-- Styles -->
    ...
    <div id="app">
        <nav class="navbar fixed-bottom navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <a class="navbar-brand" href="{{ url('/questoes') }}">
                    <span class="oi" data-glyph="clipboard"></span>
                </a>
                <a class="navbar-brand" href="{{ url('/dashboard') }}">
                    <span class="oi" data-glyph="graph"></span>
                </a>
